...
<body>
    ...
    <nav class="pcoded-navbar layout-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <h6>To use this layout for your project add <code><strong>.layout-4</strong></code> class in <code><strong>&lt;nav&gt;</strong></code> tag.</h6>
                                            <pre>
